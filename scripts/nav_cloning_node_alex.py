...
class nav_cloning_node:
    ...
    def loop(self):
        ...
        if self.is_started == False:
            return
        img = resize(self.cv_image, (256, 256), mode='constant')
        # r, g, b = cv2.split(img)
        # img = np.asanyarray([r,g,b])

        img_left = resize(self.cv_left_image, (256, 256), mode='constant')
        #r, g, b = cv2.split(img_left)
        #img_left = np.asanyarray([r,g,b])

        img_right = resize(self.cv_right_image, (256, 256), mode='constant')
