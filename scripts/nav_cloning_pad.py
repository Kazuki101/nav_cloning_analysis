...
class Net(nn.Module):
    ...
    #<Network CNN 3 + FC 2> 
        ...
        self.fc4 = nn.Linear(4032, 512)
        self.fc5 = nn.Linear(512,n_out)
        self.relu = nn.ReLU(inplace=True)
        self.flatten = nn.Flatten()
        self.deconv1 = nn.ConvTranspose2d(1, 1, 8, stride=4, padding=4, bias=False)
        self.deconv2 = nn.ConvTranspose2d(1, 1, 3, stride=2, padding=1, bias=False)
        self.deconv3 = nn.ConvTranspose2d(1, 1, 3, stride=1, padding=1, bias=False)
    ...
    def feature2image(self, conv1, conv2, conv3):
        ...
        ave2_reshape = torch.reshape(conv2, (1, 1, 7, 9))
        ave3_reshape = torch.reshape(conv3, (1, 1, 7, 9))
